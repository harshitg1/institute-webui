...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border bg-white shadow-sm overflow-hidden overflow-x-auto relative min-h-[200px]">
        {isLoading && (
            ...
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-32 text-center text-slate-500 font-medium">
                  {isLoading ? "Fetching records..." : "No results found."}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
      ...
      <div className="flex items-center justify-between px-2">
        ...
        <div className="flex items-center space-x-6 lg:space-x-8">
          <div className="flex items-center space-x-2">
            ...
            <select
              className="h-8 w-[70px] rounded-md border border-input bg-transparent px-2 py-1 text-sm outline-none focus:ring-1 focus:ring-violet-500"
