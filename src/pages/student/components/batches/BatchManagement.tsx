  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between pb-4">
        <div>
          <h2 className="text-[15px] font-medium text-zinc-900">Batches</h2>
          <p className="text-zinc-500 text-[12px] mt-0.5">Manage training batches and attendance</p>
        </div>
        <Button
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        ...
        <div className="flex items-center justify-between pt-8 border-t border-zinc-100 mt-6">
          ...
          <div className="flex gap-2">
            <Button variant="outline" className="rounded h-8 border-zinc-200 px-4 text-[11px] text-zinc-500 disabled:opacity-40" disabled>
              Previous
            </Button>
            <Button variant="outline" className="rounded h-8 border-zinc-200 px-4 text-[11px] text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100">
              Next
            </Button>
          </div>
        </div>
